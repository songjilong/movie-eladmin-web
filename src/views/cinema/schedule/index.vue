  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <label class="el-form-item-label">电影id</label>
        <el-input v-model="query.movieInfoId" clearable placeholder="电影id" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <date-range-picker
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="120px">
          ...
          <el-form-item label="放映厅id" prop="hallId">
            <el-input v-model="form.hallId" style="width: 330px;" />
          </el-form-item>
          <el-form-item label="电影id" prop="movieInfoId">
            <el-input v-model="form.movieInfoId" style="width: 330px;" />
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="movieInfoId" label="电影id" />
...
const defaultForm = { scheduleId: null, beginTime: null, price: null, remain: null, hallId: null, movieInfoId: null, createBy: null, updateBy: null, createTime: null, updateTime: null }
export default {
  name: 'Schedule',
  ...
  data() {
    return {
      ...
      queryTypeOptions: [
        ...
        { key: 'movieInfoId', display_name: '电影id' }
      ]
    }
  },
  methods: {
